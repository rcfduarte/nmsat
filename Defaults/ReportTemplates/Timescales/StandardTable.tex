...
\begin{table}[ph]
    ...
    \begin{tabular}{|@{\hspace*{1mm}}p{4cm}@{}|@{\hspace*{1mm}}p{11.75cm-\arrayrulewidth}@{\hspace*{1mm}}|}
	    ...
	    %$\tauw \frac{dw_{i}}{dt} = a_{i} \left(V_{i}(t) - V_{\mathrm{rest}}\right) - w_{i}(t) + b_{i} \tauw \sum_{t^{f}} \delta (t - t^{f})$
    ...
    \begin{tabular}{|@{\hspace*{1mm}}p{4cm}@{}|@{\hspace*{1mm}}p{11.75cm-\arrayrulewidth}@{\hspace*{1mm}}|}
        ...
        \end{multline}
        %$g^{\mathrm{syn}}_{\mathrm{ij}}(t) = \sum_{f} \bar{g}^{\mathrm{syn}}_{\mathrm{ij}}(t) \langle 1 - e^{-(t-t^{f})/\taur} \rangle \langle c_{\mathrm{syn}} e^{-(t-t^{f})/\taudecf} + (1 - c) e^{-(t-t^{f})/\taudecs} \rangle \Theta(t-t^{f})$
        %\quad{}

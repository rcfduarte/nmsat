...
# =================================================================================
params_file = '../parameters/singleneuron_synapticinput.py'
...
net.simulate(parameter_set.kernel_pars.sim_time + nest.GetKernelStatus()['resolution'])  # +1 to acquire last step...
#######################################################

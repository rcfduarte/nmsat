...
run = 'local'
data_label = 'ST_twopool_noisedriven_plot_61'
...
def build_parameters():
	...
	recurrent_synapses = dict(
		...
		pre_computedW=[None, None, None, None, None, None, None, None, None],
		weights=[wE, wE, wE,
				 wI, wI,
				 wE, wE, 
				 wI, wI],
		delays=[delay, delay, delay, delay, delay, delay, delay, delay, delay],

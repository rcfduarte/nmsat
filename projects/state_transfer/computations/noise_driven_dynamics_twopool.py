...
def run(parameter_set, plot=False, display=False, save=True):
	...
	results_merged['analog_activity']['E1'] = compute_analog_stats(net.populations[0], parameter_set, ["V_m"],
	                                                               analysis_interval, plot)
	results_merged['analog_activity']['I1'] = compute_analog_stats(net.populations[1], parameter_set, ["V_m"],
	                                                               analysis_interval, plot)
	results_merged['analog_activity']['E2'] = compute_analog_stats(net.populations[2], parameter_set, ["V_m"],
	                                                               analysis_interval, plot)
	results_merged['analog_activity']['I2'] = compute_analog_stats(net.populations[3], parameter_set, ["V_m"],
	                                                               analysis_interval, plot)

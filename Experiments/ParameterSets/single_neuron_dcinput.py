...
- to run with function single_neuron_dcinput in Computation
or with SingleNeuron_DC.py (debugging)
"""

total_time = ParameterRange("total_time", [100000., 1.])
analysis_interval = 1000.
min_current = 0.
max_current = 1000.

nodes = ParameterRange("nodes", [1, 2])
ppn = 8
mem = 32
N_vp = nodes * ppn
